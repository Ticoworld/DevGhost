const SENSITIVE_LINE_PATTERNS = [
    ...
    /\bDATABASE_URL\b\s*[:=]/i,
    /\b(?:API_KEY|CLIENT_SECRET|ACCESS_KEY|PASSWORD|PRIVATE_KEY|JWT_SECRET|WEBHOOK_SECRET|OPENAI_API_KEY|ANTHROPIC_API_KEY|GEMINI_API_KEY)\b\s*[:=]/i,
    /\b(?:TOKEN|SECRET)\b\s*[:=]\s*['"`]?[A-Za-z0-9._=/-]{16,}/i,
    /\b(?:authorization|bearer)\b\s*[:=]?\s*Bearer\s+[A-Za-z0-9._=-]{20,}/i,
    /\bRPC_URL\b.*\bkey\b/i,
];
